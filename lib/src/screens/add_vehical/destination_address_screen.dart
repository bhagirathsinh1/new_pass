...
class DestinationAddressScreen extends StatefulWidget {
  const DestinationAddressScreen({Key? key, this.address}) : super(key: key);
...
// }
  ...
  void updatedestinationAddress() async {
    setState(() {
      isLoading = true;
    });
    ...
    var address = Address(
        ...
        // addressLine1: _padd1Controller.text,
        ...
        lat: latt,
        long: long);
    mapData['destinationAddress'] = address;
    ...
    try {
      ...
      if (response.statusCode == 201 || response.statusCode == 200) {
        ...
        prefs.setString('customer_destinationAddress', jsonEncode(address));
